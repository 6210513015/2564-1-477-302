<?php
    ...
    // fetch records
    $sql = "SELECT * form users ORDER BY user_id DESC";
     ...
     <div class="container-fluid">
     	...
     	<div class="collapse navbar-collapse" id="navbar1">
     		<ul class="nav navbar-nav navbar-right">
                 ...
                 <?php } else { ?>
                    <!-- true -->
                    <li><p class ="navabar-text">Signed in as <?php echo $_SESSION['name']; ?></p></li>
...
<script>
    function delete_user(id) {
        if (confirm("Are you sure to delete this record?")) {
            widow.location.href = "show_user.php?user_id=" + id;
        }
    }

    function update_user(id) {
        window.location.herf = "update_user.php?user_id=" + id;
    }
 </body>
 </html>
